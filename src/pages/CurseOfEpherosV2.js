...
const CurseOfEpherosV2 = () => {
    return (
        <div>
          <TopBanner/>
          <div className="report-container">
              <header>
                <h1>The Curse of Erephos</h1>
                <h3><a href="./Curse-Of-Epheros-V1">Curse of Epheros Prototype</a></h3>
                
                <h3><a href="#gameplay-demo">Full Gameplay Demo</a></h3>
  ...
  <h3 id="gameplay-demo">Full Demo Playthrough</h3>
  <p>
...
export default CurseOfEpherosV2;
